    ...
    if (isOpen) {
      if (expenseToEdit) {
        setFormData({
          ...
          date: formatInputDate(expenseToEdit.date),
        });
      } else {
        setFormData({
          amount: "",
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-[11px] font-bold uppercase tracking-widest mb-1.5" style={{ color: "#aeaeb2" }}>
              Description / Merchant <span style={{ color: "#dc2626" }}>*</span>
            </label>
            <input
              type="text"
              name="description"
              ...
              onChange={handleChange}
              placeholder="e.g. Grocery Store, Coffee, Rent"
          ...
          <div className="pt-3 flex gap-3">
            <button
              type="button"
              onClick={onClose}
              className="modal-cancel flex-1 py-3 px-4 font-semibold text-sm rounded-xl active-press cursor-pointer transition-colors"
              style={{
                background: "#f5f5f7",
                color: "#6e6e73",
                border: "1px solid rgba(0,0,0,0.08)",
            ...
            <button
              type="submit"
              className="modal-primary flex-1 py-3 px-4 text-white font-semibold text-sm rounded-xl shadow-sm shadow-indigo-500/20 active-press cursor-pointer"
